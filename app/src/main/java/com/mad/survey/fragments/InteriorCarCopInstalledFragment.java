...
public class InteriorCarCopInstalledFragment extends BaseFragment implements View.OnClickListener , OnFragmentResumedListener{

    private TextView txtCarNumber;
    private TextView txtSubTitle;
    private CheckBox chkYes,chkNo,chkDontKnow;

    public static InteriorCarCopInstalledFragment newInstance(){
        InteriorCarCopInstalledFragment fragment = new InteriorCarCopInstalledFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View parent = inflater.inflate(R.layout.fragment_interior_car_cop_installed, container, false);
    ...
    private void initView(View parent){
        ...
        chkDontKnow = (CheckBox) parent.findViewById(R.id.chkDontKnow);

        parent.findViewById(R.id.btnYes).setOnClickListener(this);
        parent.findViewById(R.id.btnNo).setOnClickListener(this);
        parent.findViewById(R.id.btnDontKnow).setOnClickListener(this);
    ...
    private void updateUIs(){
        ...
        String isThereNewCop = interiorCarDoorData.getIsThereNewCop();
        switch (isThereNewCop){
            case "YES":
            ...
            case "NO":
                ...
                break;
            case "DON'T KNOW":
                chkDontKnow.setChecked(true);
                break;
        }
    }

    private void saveData(String isThereNewCop){
        MADSurveyApp.getInstance().getInteriorCarDoorData().setIsThereNewCop(isThereNewCop);
    ...
    private void goToMainCop(){
        saveData("YES");
        ((BaseActivity) getActivity()).replaceFragment(BaseActivity.FRAGMENT_ID_INTERIOR_CAR_MAINCOP_RETURN, "interior_car_maincop_return");
    }
    private void goToAuxCop(){
        saveData("YES");
