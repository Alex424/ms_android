...
public class HallStationWallmaterialFragment extends BaseFragment implements View.OnClickListener , OnFragmentResumedListener{
    ...
    public static HallStationWallmaterialFragment newInstance(){
        HallStationWallmaterialFragment fragment = new HallStationWallmaterialFragment();
        return fragment;
    }
    public static HallStationWallmaterialFragment newInstance(boolean tag){
        flag = tag;
        HallStationWallmaterialFragment fragment = new HallStationWallmaterialFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View parent = inflater.inflate(R.layout.fragment_hallstation_wallmaterial, container, false);
    ...
    private void updateUIs(){
        ...
        String wallMaterial = hallStationData.getWallFinish();
        switch (wallMaterial){
    ...
    private void goToNext(String wallMaterial){
        HallStationData hallStationData = MADSurveyApp.getInstance().getHallStationData();
        hallStationData.setWallFinish(wallMaterial);
        ...
        if(flag){
            ...
            ((BaseActivity) getActivity()).replaceFragment(BaseActivity.FRAGMENT_ID_HALLSTATION_MEASUREMENTS, "hallstation_measurements");
    }
