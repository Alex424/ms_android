...
public class CarRidingLanternMountingFragment extends BaseFragment implements View.OnClickListener , OnFragmentResumedListener{

    private TextView txtCarNumber;
    private TextView txtSubTitle;
    private CheckBox chkFlushMounting,chkSurfaceMounting;

    public static CarRidingLanternMountingFragment newInstance(){
        CarRidingLanternMountingFragment fragment = new CarRidingLanternMountingFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View parent = inflater.inflate(R.layout.fragment_car_riding_lantern_mounting, container, false);
    ...
    private void updateUIs(){
        ...
        String mount = carData.getMountCDI();
    ...
    private void goToNext(String mount){
        CarData carData = MADSurveyApp.getInstance().getCarData();
        carData.setMountCDI(mount);
        MADSurveyApp.getInstance().setCarData(carData);
        carDataHandler.update(carData);
        ((BaseActivity) getActivity()).replaceFragment(BaseActivity.FRAGMENT_ID_CAR_RIDING_LANTERN_MEASUREMENTS, "car_riding_lantern_measurements");
    }
