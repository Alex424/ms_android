...
public class HallEntranceTransomMeasurements1sFragment extends BaseFragment implements View.OnClickListener , OnFragmentResumedListener{

    private TextView txtCarNumber;
    private TextView txtFloorIdentifier;
    private EditText edtA, edtB, edtC, edtD, edtE, edtF, edtG;

    public static HallEntranceTransomMeasurements1sFragment newInstance(){
        HallEntranceTransomMeasurements1sFragment fragment = new HallEntranceTransomMeasurements1sFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View parent = inflater.inflate(R.layout.fragment_hall_entrance_transom_measurements_1s, container, false);
    ...
    private void initView(View parent){
        ...
        setHeaderScrollConfiguration(parent, getString(R.string.hall_entrance), getString(R.string.sub_title_transom_measurements_1s), true, true);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btnNext:
                ...
                break;
            case R.id.btnHelp:
                showHelpDialog(getActivity(), getString(R.string.help_title_hall_entrance), R.drawable.img_help_55_hall_entrance_transom_measurements_1s_help, GlobalConstant.HELP_PHOTO_SIZE_RATE);
                break;
        }
    }
